    ...
    try {
      ...
      if (post) {
        ...
        if (post.author?.id === loggedInUserId) {
            document.getElementById('deletePostButton').style.display = 'block'; // Show delete button
          } else {
            document.getElementById('deletePostButton').style.display = 'none'; // Hide delete button
          }
