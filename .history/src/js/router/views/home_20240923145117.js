...
function renderPost(post) {
    ...
    postContainer.setAttribute("data-post-id", post.id); // Set the post ID as a data attribute

    // Add an event listener for clicking on the post
    postContainer.addEventListener('click', function() {
        // When clicked, redirect to the single post page and pass the post ID as a query parameter
